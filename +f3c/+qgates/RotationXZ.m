%> @file RotationXZ.m
%> @brief Implements RotationXZ class.
% ==============================================================================
%> @class RotationXZ
%> @brief 2-qubit XZ rotation gates stored in rotation representation
%>
%> 2-qubit XZ rotation gate with matrix representation:
%>
...
% ==============================================================================
classdef RotationXZ < f3c.qgates.TwoAxesRotationGate2
  ...
  methods
    ...
    function [out] = toQASM(obj,fid, offset)
      ...
      f3c.IO.qasmRotationXZ( fid, obj.qubits + offset, ...
    ...
    function [bool] = equalType(~, other)
      bool = isa(other,'f3c.qgates.RotationXZ');
    end
