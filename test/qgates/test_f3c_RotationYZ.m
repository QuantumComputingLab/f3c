classdef test_f3c_RotationYZ < matlab.unittest.TestCase
  methods (Test)
    function test_RotationYZ_basic_functionality(test)
      YZ = @f3c.qgates.RotationYZ ;
    ...
    function test_RotationYZ_constructors(test)
      tol = 10*eps;
      YZ = @f3c.qgates.RotationYZ ;
    ...
    function test_RotationYZ_update(test)
      tol = 10*eps;
      YZ = @f3c.qgates.RotationYZ ;
    ...
    function test_RotationYZ_matrix( test )
      tol = 10*eps;
      YZ = @f3c.qgates.RotationYZ ;
    ...
    function test_RotationYZ_fuse_multiply( test )
      tol = 10*eps;
      YZ = @f3c.qgates.RotationYZ ;
    ...
    function  test_RotationYZ_turnover( test )
      tol = 10*eps;
      YZ = @f3c.qgates.RotationYZ ;
      ...
      theta1 = [ pi/7, 5.33];
      G1 = YZ([0, 1], theta1(1), theta1(2) );
      
      theta2 = [ pi/4, -2.21];
      G2 = YZ([1, 2], theta2(1), theta2(2) );
      
      theta3 = [ -0.81, pi/5];
      G3 = YZ([0, 1], theta3(1), theta3(2) );
      ...
      G1 = YZ([1, 2], theta1(1), theta1(2) );      
      G2 = YZ([0, 1], theta2(1), theta2(2) );      
      G3 = YZ([1, 2], theta3(1), theta3(2) );
